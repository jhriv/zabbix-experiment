...
GUESTS = [
  ...
  { name: 'db-2',    box: 'centos/7', ip: 'dhcp' },
  { name: 'proxy-1', box: 'centos/7', ip: 'dhcp', ports: [{ guest: 80, host: 8088 }] },
  { name: 'proxy-2', box: 'centos/7', ip: 'dhcp', ports: [{ guest: 80, host: 8089 }] },
  { name: 'web-1',   box: 'centos/7', ip: 'dhcp' },
  { name: 'web-2',   box: 'centos/7', ip: 'dhcp' },
